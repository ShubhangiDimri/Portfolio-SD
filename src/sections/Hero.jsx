                        ...
                        >
                            ...
                            <a
                                ...
                                className="w-10 h-10 rounded-xl bg-white/[0.05] border border-white/[0.08] flex items-center justify-center
                                    text-zinc-400 hover:text-[#FF6B00] hover:border-[#FF6B00]/40 hover:bg-white/[0.08]
                                    transition-all duration-300"
                                data-magnetic
                            >
                            ...
                            {/* LeetCode */}
                            <a
                                href="https://leetcode.com/u/chaskaCHokirin22/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-xl bg-white/[0.05] border border-white/[0.08] flex items-center justify-center
                                    text-zinc-400 hover:text-[#FF6B00] hover:border-[#FF6B00]/40 hover:bg-white/[0.08]
                            ...
                            <span className="text-xs text-zinc-600 font-mono ml-1">/ connect</span>
                        </motion.div>
